...
public class ClientD 
{
    public static void main(String[] args) 
	{
       ...
       int d_p_1=Integer.parseInt(args[3]);
        int d_p_2=Integer.parseInt(args[4]);
        int d_p_3=Integer.parseInt(args[5]);
       int ctr1=0;
        try 
		{
            ...
            while(true)
            {
               ...
               // System.out.println(data);
                while(data.equals("Send Again"))//while
                {
                    data_ar=Recieve(cs);
                    data=new String(data_ar);
                    //break;
                ...
                data_array[consignment_no]=data;
                arr[consignment_no]=data_ar;
                if((consignment_no==d_p_2 ||consignment_no== d_p_1||consignment_no==d_p_3)&&ctr1==0)
                {
                    System.out.println("ACK NOT SENT"+consignment_no);
                    System.out.println();
                    ctr1=ctr1+1;
                }
                    else
